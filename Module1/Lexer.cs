...
public class Program
{
    public static void Main()
    {
        ...
        string input1_2 = "0123";
        Lexer L1_2 = new NumLexer(input1_2);
        try
        {
            L1_2.Parse();
        }
        ...
        string input3_3 = "+256";
        Lexer L3_3 = new SignLexer(input3_3);
        try
        {
            L3_3.Parse();
        }
        ...
        string input5_3 = "a,g;e;aa,g";
        Lexer L5_3 = new DelimLexer(input5_3);
        try
        {
            L5_3.Parse();
        }
